...
class OpenAIService:
    def invoke(self, messages: Sequence[ChatMessage]) -> ChatMessage:
        pass
    ...
    def invoke_with_tools(
        ...
        response = completion(
            ...
            tools=[
                {"type": "function", "function": OpenAIService._convert_tools(name, tool)}
        ...
        return AssistantMessage(
            ...
            tool_calls=[ToolCall.from_litellm_format(tool_call) for tool_call in message.tool_calls] if
            message.get("tool_calls") is not None else None
        )
